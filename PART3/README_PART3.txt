Pembahasan Style, Formating, dan Comment di HTML

Pembahasan Style atau yang sering dikenal dengan CSS (Untuk bahasan lanjutan nanti ada bahasan sendiri)
...
- Namun pada sesi html dasar part 3 ini, kita akan bahas sekilas cara menggunakan CSS yang sederhana.
...
- Style attribute berisikan key:value CSS,  (titikjika lebih dari satu, maka gunakan ; koma) sebagai pemisah, misal :
...
- Begitu juga di HTML, kita bisa menambah formating di text yang ingin kita tampilkan menggunakan tag sesuai dengan format yang kita kehendaki

Contoh Formating Tag:
...
- Untuk membuat komentar, kita bisa menggunakan <!-- isi komentar -->
